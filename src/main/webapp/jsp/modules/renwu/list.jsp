    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            row.appendChild(renwuTypesCell);
                ...
                //附件
            var renwuFileCell = document.createElement('td');
            if(item.renwuFile ==null || item.renwuFile == '' || item.renwuFile == 'null'){
                    renwuFileCell.innerHTML = '没有下载文件';
            }else {
                var renwuFileFile = document.createElement('button');
                    renwuFileFile.innerHTML = '下载';
                var renwuFileFileAttr = "download('" + item.renwuFile + "')"
                    renwuFileFile.setAttribute('onclick',renwuFileFileAttr);
                    renwuFileCell.appendChild(renwuFileFile);
            }
            row.appendChild(renwuFileCell);
