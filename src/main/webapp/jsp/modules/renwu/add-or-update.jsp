                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>附件</label>
                                        <input name="file" type="file" class="form-control-file" id="renwuFileupload">
                                        <label id="renwuFileName"></label>
                                        <input name="renwuFile" id="renwuFile-input" type="hidden">
                                    </div>
                                    <div class="form-group  col-md-6">
                                        <label>任务详情</label>
...
<script>
    ...
    function upload() {
        ...
        $('#renwuFileupload').fileupload({
            url: baseUrl + 'file/upload',
            headers: {token: window.sessionStorage.getItem("token")},
            dataType: 'json',
            done: function (e, data) {
                document.getElementById('renwuFile-input').setAttribute('value', baseUrl + 'file/download?fileName=' + data.result.file);
                document.getElementById('renwuFileName').innerHTML = "上传成功!";
            }
        });
