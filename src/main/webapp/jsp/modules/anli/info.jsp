            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">案例登记</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 级联表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="nianjiValue" name="nianjiValue" class="form-control"
                                               v-model="ruleForm.nianjiValue" readonly>
                                    </div>
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="anliName" name="anliName" class="form-control"
                                               v-model="ruleForm.anliName" readonly>
                                    </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="anliZhutiValue" name="anliZhutiValue" class="form-control"
                                           v-model="ruleForm.anliZhutiValue" readonly>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="anliValue" name="anliValue" class="form-control"
                                           v-model="ruleForm.anliValue" readonly>
                                </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="anliXingshi" name="anliXingshi" class="form-control"
                                               v-model="ruleForm.anliXingshi" readonly>
                                    </div>

                                <div class="form-group col-md-6">
                                    <label>案例缩略图</label>
                                    <img id="anliPhotoImg" width="100" height="100">
                                </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.anliContent != null && ruleForm.anliContent != 'null' && ruleForm.anliContent != '') {
            var anliContentUeditor = UE.getEditor('anliContentEditor');
                anliContentUeditor.ready(function () {
                    var mes = '' + ruleForm.anliContent;
                    anliContentUeditor.setContent(mes);
                    anliContentUeditor.setDisabled('fullscreen');
            });
        }
    }
    ...
    function setDownloadBtn() {
        var anliFileUrl = "download('" + ruleForm.anliFile + "')";
        $("#anliFile").attr("onclick", anliFileUrl);
