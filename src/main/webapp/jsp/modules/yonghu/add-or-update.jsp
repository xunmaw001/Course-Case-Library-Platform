                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>年级</label>
                                        <select id="nianjiTypesSelect" name="nianjiTypes" class="form-control">
                                        </select>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>权限</label>
...
<script>
    ...
    // 查询列表
        ...
        function nianjiTypesSelect() {
            //填充下拉框选项
            http("dictionary/page?page=1&limit=100&sort=&order=&dicCode=nianji_types", "GET", {}, (res) => {
                if(res.code == 0){
                    nianjiTypesOptions = res.data.list;
                }
            });
        }
    ...
    <!-- 初始化当前表的下拉框 -->
        ...
        function initializationNianjitypesSelect(){
            var nianjiTypesSelect = document.getElementById('nianjiTypesSelect');
            if(nianjiTypesSelect != null && nianjiTypesOptions != null  && nianjiTypesOptions.length > 0 ){
                for (var i = 0; i < nianjiTypesOptions.length; i++) {
                    nianjiTypesSelect.add(new Option(nianjiTypesOptions[i].indexName,nianjiTypesOptions[i].codeIndex));
                }
            }
        }
    ...
    function setSelectOption() {
        ...
        if(nianjiTypesSelect != null && nianjiTypesOptions != null  && nianjiTypesOptions.length > 0 ) {
            for (var i = 0; i < nianjiTypesOptions.length; i++) {
                if (nianjiTypesOptions[i].codeIndex == ruleForm.nianjiTypes) {//下拉框value对比,如果一致就赋值汉字
                        nianjiTypesSelect.options[i].selected = true;
                }
            }
        }
    ...
    $(document).ready(function () {
        ...
        // 初始化下拉框
            ...
            initializationNianjitypesSelect();
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            ...
            $('#roleTypesSelect').attr('readonly', 'readonly');
            $('#roleTypesSelect').attr('style', 'pointer-events: none;');
            $('#xueyuanTypesSelect').attr('readonly', 'readonly');
            $('#xueyuanTypesSelect').attr('style', 'pointer-events: none;');
            $('#nianjiTypesSelect').attr('readonly', 'readonly');
            $('#nianjiTypesSelect').attr('style', 'pointer-events: none;');
        }
