                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="yonghuNumber" id="yonghuNumber" placeholder="编号" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    ...
    // 当前表的字典表
       ...
       function xueyuanTypesSelect() {
           http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=xueyuan_types", 'get', {}, function (res) {
               if(res.code == 0){
       ...
       function nianjiTypesSelect() {
           http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=nianji_types", 'get', {}, function (res) {
               if(res.code == 0){
       ...
       function roleTypesSelect() {
           http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=role_types", 'get', {}, function (res) {
               if(res.code == 0){
