                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="renwuName" id="renwuName" placeholder="任务名称" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 renwuContent 字段去除无用字符 如果字段长度大于60  就截取到60
            renwuContent: function(val) {
                if (val) {
