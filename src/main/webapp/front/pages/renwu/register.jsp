              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">任务名称:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="renwuName" id="renwuName"  placeholder="任务名称"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">任务类型:</span>
                        <div class="layui-input-inline">
                            <select name="renwuTypes" id="renwuTypes" lay-filter="renwuTypes" style="width: 600px;">
